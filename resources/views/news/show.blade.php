            ...
            <div class="mb-10 text-center">
                ...
                <div class="flex flex-col border-t border-b border-gray-100 py-6 mb-8 mt-2">
                    ...
                    <div class="flex items-center space-x-3">
                        <span class="text-[11px] font-bold uppercase tracking-widest text-gray-400 mr-2">Bagikan:</span>
                        
                        <!-- WhatsApp -->
                        <a href="https://api.whatsapp.com/send?text={{ urlencode($post->title . "\n\n" . request()->url()) }}" target="_blank" class="w-9 h-9 rounded-full flex items-center justify-center text-white transition hover:opacity-80 shadow-sm" style="background-color: #25D366;">
                        ...
                        <!-- Facebook -->
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(request()->url()) }}" target="_blank" class="w-9 h-9 rounded-full flex items-center justify-center text-white transition hover:opacity-80 shadow-sm" style="background-color: #3b5998;">
                        ...
                        <!-- X (Twitter) -->
                        <a href="https://twitter.com/intent/tweet?text={{ urlencode($post->title) }}&url={{ urlencode(request()->url()) }}" target="_blank" class="w-9 h-9 rounded-full flex items-center justify-center text-white transition hover:opacity-80 shadow-sm" style="background-color: #000000;">
                        ...
                        <!-- Copy Link -->
                        <button type="button" onclick="navigator.clipboard.writeText('{{ request()->url() }}'); alert('Link berhasil disalin!')" class="w-9 h-9 rounded-full flex items-center justify-center text-white transition hover:opacity-80 shadow-sm" style="background-color: #9CA3AF;">
